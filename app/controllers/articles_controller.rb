class ArticlesController < ApplicationController
  ...
  def learn
    ...
    LinkTag.where(tag_id: 2).each do |learn_link|
  ...
  def text
    ...
    LinkTag.where(tag_id: 2).each do |text_link|
  ...
  def audio
    ...
    LinkTag.where(tag_id: 2).each do |audio_link|
  ...
  def game
    ...
    LinkTag.where(tag_id: 2).each do |game_link|
